  ...
  return (
    <div className="space-y-6">
      <div className="bg-blue-50 p-6 rounded-lg">
        <h3 className="text-xl font-semibold mb-4">Reading Passage {question.index != null ? question.index + 1 : ''}</h3>

        <div className="space-y-4">
          <div className="bg-white p-4 rounded-lg">
            <h4 className="font-medium mb-2">Passage:</h4>
            <p className="text-gray-700 leading-relaxed">{question.passageText || question.passage || 'Passage not available'}</p>
          </div>
              ...
              <div className="space-y-6">
                {question.questions.map((subQuestion, subIndex) => (
                  <div key={`${question.id}-${subIndex}`} className="bg-gray-50 p-4 rounded-lg">
                    <h5 className="font-semibold text-gray-800 mb-3">Question {subIndex + 1}: {subQuestion.text || subQuestion.question}</h5>
