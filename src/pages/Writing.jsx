      ...
      <div className="w-full  bg-white rounded-3xl shadow-2xl border border-gray-200 p-8 md:p-12">
        <div className="text-center mb-10">
          ...
          <p className="text-lg md:text-xl text-gray-700 font-medium max-w-2xl mx-auto leading-relaxed">
            Write your answer to the prompt below.
          </p>
        </div>
        {!submitted ? (
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <textarea
              className="w-full min-h-screen rounded-2xl border border-gray-200 bg-gray-50 p-5 text-lg shadow focus:outline-none focus:ring-4 focus:ring-primary-200 focus:border-primary-400 transition-all resize-y placeholder-gray-400"
              value={answer}
