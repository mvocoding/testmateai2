    ...
    <div className="min-h-screen bg-gray-50 relative overflow-hidden flex flex-col">
      <div className="text-center mb-10 p-10">
        ...
        <p className="text-xl md:text-2xl text-gray-700 font-medium max-w-2xl mx-auto leading-relaxed">
          Master IELTS with <span className="text-teal-600 font-bold">AI-powered</span> learning.<br />
          Practice speaking, get instant feedback, and level up your English skills in a gamified adventure!
        </p>
      </div>
      <div className="relative w-full max-w-4xl mx-auto mb-12">
        <div className="relative bg-white rounded-3xl shadow-2xl border border-gray-200 p-8 md:p-12 flex flex-col md:flex-row gap-8 items-center justify-center"> {/* Neutral card */}
          <div className="flex-1 flex flex-col gap-6 items-center">
            <div className="w-full bg-white rounded-2xl shadow-xl p-6 flex flex-col gap-2 border-2 border-gray-200">
              <h2 className="text-lg font-bold text-teal-700 flex items-center gap-2"><span role="img" aria-label="game">🎮</span> Gamified Features</h2>
